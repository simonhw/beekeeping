...
- New fixed dimensions were set for the shop images and they were resized to 222px square. This resulted in an improved Performance score of 91; however, the image of the beekeeper suit looked a little pixelated and in my option detracted from the user experience. I re-inserted the higher-resolution image and the final Performace score for shop.html was 84.
